...
function insertElement(parentObject, elementObject) {
  ...
  var markup = '<div class="c-carousel__controls"><a href="#" class="c-carousel__control-link c-carousel__control-link--previous"><i class="c-carousel__control-icon c-carousel__control-icon-chevron c-carousel__control-icon-chevron--previous"></i></a><a href="#" class="c-carousel__control-link c-carousel__control-link--next"><i class="c-carousel__control-icon c-carousel__control-icon-chevron c-carousel__control-icon-chevron--next"></i></a></div><div class="c-carousel__viewport"><div class="c-carousel"><div class="c-carousel__card">' + elementObject.text + '</div><div class="c-carousel__card">Another thing with content!</div></div></div>';
